...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  'sos.disp.con.connecting':  { en: 'Sending to 911 · RapidSOS',  zh: '正在发送到 911 · RapidSOS' },
  'sos.disp.con.alerted':     { en: '3 helpers alerted', zh: '已通知 3 名响应者' },
  'sos.disp.con.address':     { en: '123 Main St · Westwood', zh: '主街 123 号 · Westwood' },
  'sos.disp.con.viewMap':     { en: 'View live map',  zh: '查看实时地图' },
  'sos.disp.con.viewMap.sub': { en: 'Track helpers and AED en route', zh: '追踪响应者与 AED 抵达情况' },
  ...
  'sos.disp.con.symptomsLogged':        { en: '{n} symptom logged · synced to dispatch',  zh: '已记录 {n} 项症状 · 同步到调度' },
  'sos.disp.con.symptomsLogged.plural': { en: '{n} symptoms logged · synced to dispatch', zh: '已记录 {n} 项症状 · 同步到调度' },

  // ── SOS / symptoms ────────────────────────────────────────────────────
  'sos.symp.title':           { en: 'Log symptoms for EMS', zh: '为急救记录症状' },
  'sos.symp.intro':           { en: 'Tap anything that applies. Notes go straight to dispatch.', zh: '点击所有适用项。备注会直接同步给调度。' },
  'sos.symp.section.tap':     { en: 'WHAT DO YOU SEE?', zh: '你看到了什么？' },
  'sos.symp.section.notes':   { en: 'NOTES (OPTIONAL)', zh: '备注（可选）' },
  'sos.symp.notes.placeholder': { en: 'e.g. "Started 5 min ago after climbing stairs"', zh: '例如 "5 分钟前爬楼梯后开始"' },
  'sos.symp.send':            { en: 'Send to EMS', zh: '发送给急救' },
  'sos.symp.sending':         { en: 'Sending…', zh: '发送中…' },
  'sos.symp.sent.title':      { en: 'Sent to EMS', zh: '已发送给急救' },
  'sos.symp.sent.body':       { en: 'Dispatch has your notes and will brief the crew before arrival.', zh: '调度已收到，会在抵达前告知急救人员。' },
  'sos.symp.sent.done':       { en: 'Back to monitoring', zh: '返回监测' },
  'sos.symp.chip.chest':      { en: 'Chest pain',           zh: '胸痛' },
  'sos.symp.chip.arm':        { en: 'Pain in arm / jaw / back', zh: '手臂 / 下巴 / 背痛' },
  'sos.symp.chip.numb':       { en: 'Numbness or weakness', zh: '麻木或无力' },
  'sos.symp.chip.speech':     { en: 'Slurred speech / confusion', zh: '说话不清 / 意识模糊' },
  'sos.symp.chip.breath':     { en: 'Shortness of breath',  zh: '呼吸困难' },
  'sos.symp.chip.dizzy':      { en: 'Dizziness / lightheaded', zh: '头晕 / 轻飘飘' },
  'sos.symp.chip.sweat':      { en: 'Sweating / cold skin', zh: '出汗 / 皮肤湿冷' },
  'sos.symp.chip.nausea':     { en: 'Nausea',               zh: '恶心' },
  ...
  'sos.disp.un.titleConfirm':  { en: 'Slide to alert 911\nand dispatch helpers.', zh: '滑动通知 911\n并派遣响应者。' },
  'sos.disp.un.callBoth':      { en: 'Send data to 911 + alert helpers', zh: '发送数据到 911 + 通知响应者' },
  'sos.disp.un.slideHelp':     { en: 'Pushes your data straight to dispatch via RapidSOS. No voice call.', zh: '通过 RapidSOS 把你的数据直接推送到调度。不是语音呼叫。' },
  'sos.disp.un.slideLabel':    { en: 'Slide to alert 911', zh: '滑动通知 911' },
  'sos.disp.un.slideConfirmed':{ en: 'Sent to 911',    zh: '已发送给 911' },
  'sos.disp.un.connecting':    { en: 'Sending to 911 · RapidSOS',  zh: '正在发送到 911 · RapidSOS' },
  'sos.disp.un.ringing':       { en: 'UPLOADED · {time} · live data syncing', zh: '已上传 · {time} · 实时数据同步中' },
  ...
  'sos.disp.un.btnDisabled':   { en: 'SEND TO 911 FIRST',   zh: '请先发送到 911' },

  // ── RapidSOS upload status (replaces the old "ringing" / call-time UX) ──
  'sos.send.status.sending':   { en: 'Sending…',                zh: '正在发送…' },
  'sos.send.status.sent':      { en: 'Sent',                    zh: '已发送' },
  'sos.send.status.sentLive':  { en: 'Sent · live data syncing', zh: '已发送 · 实时同步中' },

  // ── RapidSOS data-payload card (shown on dispatch screens) ────────────
  'sos.rapidsos.tag':          { en: 'RAPIDSOS',                   zh: 'RAPIDSOS' },
  'sos.rapidsos.title':        { en: 'What we send to 911',        zh: '我们发送给 911 的内容' },
  'sos.rapidsos.intro':        { en: 'No voice call. Your data goes straight to dispatch via RapidSOS so the crew arrives ready.', zh: '无语音呼叫。你的数据通过 RapidSOS 直接发到调度，急救人员到达时已就绪。' },
  'sos.rapidsos.item.location':{ en: 'Live GPS · within 4 m',      zh: '实时 GPS · 误差 4 米内' },
  'sos.rapidsos.item.medical': { en: 'Medical info · pacemaker, allergies, meds', zh: '医疗信息 · 起搏器、过敏、用药' },
  'sos.rapidsos.item.contacts':{ en: 'Emergency contacts · David, Mei', zh: '紧急联系人 · David、Mei' },
  'sos.rapidsos.item.symptoms':{ en: 'Symptoms you log here',      zh: '你在此记录的症状' },
  'sos.rapidsos.item.vitals':  { en: 'Live vitals · LifeLink Patch (when paired)', zh: '实时生命体征 · LifeLink 贴片（已配对时）' },
  ...
  'sos.complete.tl2.label':    { en: '911 alerted via RapidSOS · 3 helpers en route', zh: '已通过 RapidSOS 通知 911 · 3 名响应者赶来' },
  'sos.complete.tl2.sub':      { en: 'Location, medical info, contacts pushed to dispatch', zh: '位置、医疗信息和联系人已推送到调度' },
  ...
  'sos.map.backToStatus':  { en: 'Back to status →', zh: '返回状态 →' },
